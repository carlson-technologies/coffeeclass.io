...
description: "Learn C by creating a simple grade converter program."
seoDescription: "Learn C programming by creating a simple grade converter program using if/else, scanf, and local variables."
