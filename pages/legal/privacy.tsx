...
export default function Privacy() {
  return (
    <Container title={title} description={description} url={url}>
      <Stack spacing={8} px={4} maxW="100em">
        <Flex flexDir="column" mx={5} as="section" maxW="100em">
          ...
          <UnorderedList listStylePos="inside" color={useColorModeValue('gray.600', 'gray.400')}>
            ...
            <ListItem>
              <Text color={useColorModeValue('gray.600', 'gray.400')}>
                ...
                Carlson Technologies LLC, 224 Briarwood Lane, Middletown, CT 06457.
              </Text>
            </ListItem>
            <ListItem>
              <Text color={useColorModeValue('gray.600', 'gray.400')}>
            ...
            <ListItem>
              <Text color={useColorModeValue('gray.600', 'gray.400')}>
                <strong>Website</strong> refers to coffeeclass.io, accessible from{' '}
                <Link
                  color="blue.500"
          ...
          <UnorderedList listStylePos="inside">
            <ListItem color={useColorModeValue('gray.600', 'gray.400')}>
          ...
          <Text color={useColorModeValue('gray.600', 'gray.400')}>
            coffeeclass.io is committed to complying with the Children’s Online Privacy Protection
            Act (COPPA). We do not use our services to intentionally solicit data from or market to
            children under the age of 13. We encourage parents and guardians to report any
            suspicions that a child has provided us with information without their consent. We will
          ...
          <UnorderedList listStylePos="inside" color={useColorModeValue('gray.600', 'gray.400')}>
            <ListItem>
              By email:{' '}
              <Link href="mailto:ben@carlsontechnologies.dev" color="blue.500">
                ben@carlsontechnologies.dev
              </Link>
            </ListItem>
          </UnorderedList>
        </Flex>
