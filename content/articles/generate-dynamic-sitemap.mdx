...
<SnippetStep title="Install Dependencies" number="1" />
...
<SnippetStep title="Write Code!" number="2" />
...
<SnippetStep title="Use `globby` to find files and directories using glob patterns" number="3" />
...
<SnippetStep title="Create our `sitemap` variable" number="4" />
...
<SnippetStep title="Use `fs` To Write To Public Folder" number="5" />
