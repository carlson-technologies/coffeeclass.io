---
title: "Add Comments To Next.js Website"
description: "The easiest (and best?) way to add comments to a Jamstack website."
seoDescription: "How to add comments to a Next.js/React website? In this tutorial, we'll use utteranc - a comment solution which uses GitHub issues to store comments."
...
In this article, I'll show you how to connect [utteranc](https://utteranc.es/) to your React based application.
...
## Adding Utteranc To A React Website
...
> ❗ Make sure this repo is public and that Utteranc is authorized. ❗
