        ...
        <Container>
            ...
            >
                ...
                >
                    ...
                    <Heading as="h2" mt={4}>Interpretation and Definitions</Heading>
                    <Heading as="h2" mt={4}>Interpretation</Heading>
                    ...
                    <UnorderedList>
                        ...
                        <ListItem>
                            <Text><strong>Third-party Social Media Service</strong> refers to any website or any social network website through which a User can log in or create an account to use the Service.</Text>
                        </ListItem>
                        <ListItem>
                    ...
                    <Heading as="h2" mt={4}>Collecting and Using Your Personal Data</Heading>
                    <Heading as="h3" mt={4}>Types of Data Collected</Heading>
                    <Heading as="h4" mt={4}>Personal Data</Heading>
                    ...
                    <Heading as="h4" mt={4}>Usage Data</Heading>
                    ...
                    <Heading as="h4" mt={4}>Tracking Technologies and Cookies</Heading>
                    ...
                    <Text>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: <a href="https://www.privacypolicies.com/blog/cookies/" target="_blank">What Are Cookies?</a>.</Text>
                    ...
                    <Heading as="h3" mt={4}>Use of Your Personal Data</Heading>
                    ...
                    <Heading as="h3" mt={4}>Retention of Your Personal Data</Heading>
                    ...
                    <Heading as="h3" mt={4}>Transfer of Your Personal Data</Heading>
                    ...
                    <Heading as="h3" mt={4}>Disclosure of Your Personal Data</Heading>
                    <Heading as="h4" mt={4}>Business Transactions</Heading>
                    ...
                    <Heading as="h4" mt={4}>Law enforcement</Heading>
                    ...
                    <Heading as="h4" mt={4}>Other legal requirements</Heading>
                    ...
                    <Heading as="h3" mt={4}>Security of Your Personal Data</Heading>
                    ...
                    <Heading as="h2" mt={4}>Children's Privacy</Heading>
                    ...
                    <Heading as="h2" mt={4}>Changes to this Privacy Policy</Heading>
