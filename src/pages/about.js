        ...
        <Container title={title} description={description} url={url}>
            ...
            >
                ...
                >
                    ...
                    <Text mb={2} color={color[colorMode]} fontSize="large">coffeeclass.io is created by <Link color="blue.500" href="https://benjamincarlson.io" isExternal>Benjamin Carlson</Link>.</Text>

                    <Heading as="h2" size="lg" my={2} mt={4} fontWeight={700} letterSpacing="tight">What Is coffeeclass.io?</Heading>
                    <Text mb={2} color={color[colorMode]} fontSize="large">coffeeclass.io is a programming/computer science education service offering tutorials through this website and their <Link color="blue.500" href="https://youtube.com/benjamincarlson" isExternal>YouTube channel</Link>.</Text>
                    ...
                    <Text mb={2} color={color[colorMode]} fontSize="large">Ben started creating programming tutorials in April 2020 on his <Link color="blue.500" href="https://benjamincarlson.io" isExternal>website</Link> and YouTube channel. In April 2021, Ben stopped writing tutorials on his personal website and created this website.</Text>
