        ...
        <Container title={title} description={description} url={url}>
            ...
            >
                ...
                >
                    ...
                    <Text color={useColorModeValue("gray.600", "gray.400")}>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</Text>
                    ...
                    <UnorderedList listStylePos="inside" color={useColorModeValue("gray.600", "gray.400")}>
                        ...
                        <ListItem>
                            <Text color={useColorModeValue("gray.600", "gray.400")}><strong>Website</strong> refers to coffeeclass.io, accessible from <Link color="blue.500" href="https://www.coffeeclass.io/" rel="noreferrer" target="_blank">https://www.coffeeclass.io/</Link></Text>
                        </ListItem>
                        <ListItem>
                    ...
                    <UnorderedList listStylePos="inside">
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</ListItem>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read &apos;Where can I change the settings for disabling, or deleting local shared objects?&apos; available at <Link color="blue.500" href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" rel="noreferrer" target="_blank">https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</Link></ListItem>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</ListItem>
                    </UnorderedList>
                    <Text color={useColorModeValue("gray.600", "gray.400")}>Cookies can be &apos;Persistent&apos; or &apos;Session&apos; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies here: <Link color="blue.500" href="https://www.termsfeed.com/blog/cookies/" target="_blank" rel="noreferrer">All About Cookies by TermsFeed</Link>.</Text>
                    ...
                    <UnorderedList listStylePos="inside" color={useColorModeValue("gray.600", "gray.400")}>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service,  to contact You.</ListItem>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</ListItem>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</ListItem>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>With business partners:</strong> We may share Your information with Our business partners to offer You certain products, services or promotions.</ListItem>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</ListItem>
                        <ListItem color={useColorModeValue("gray.600", "gray.400")}><strong>With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent.</ListItem>
                    </UnorderedList>
                    ...
                    <UnorderedList listStylePos="inside" color={useColorModeValue("gray.600", "gray.400")}>
                        <ListItem>By email: <Link href="mailto:ben@carlsontechnologies.dev" color="blue.500">ben@carlsontechnologies.dev</Link></ListItem>
                    </UnorderedList>
                </Flex>
            </Stack>
        </Container>
