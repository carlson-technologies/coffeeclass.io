---
title: "Create and Run React Native Mobile App Using Expo in Under 5 Minutes!"
description: "Use Expo to create a React Native app fast!"
seoDescription: "Create a cross platform ios and Android app using React Native and run it using Expo."
author: "Benjamin Carlson"
authorImage: "benjamin-carlson.jpeg"
authorPosition: "Founder Coffeeclass"
publishedAt: "2021-08-09T14:00"
tags: ["react-native"]
type: "snippet"
logoImage: ["react-native.png"]
---

## What Is React Native?

React Native is a JavaScript framework for building cross platform mobile apps. It allows you to create native apps for Android and iOS using [React](https://reactjs.org/).
...
In this tutorial, we will be using [Expo](https://expo.dev/) with React Native. Expo acts as a container around the React Native framework that allows us to develop applications more quickly and easily compared to if we were using bare bones React Native. The first thing we need to do is install the Expo CLI command line utility. Open your terminal and run the following command:
