        ...
        <Container>
            ...
            >
                ...
                >
                    ...
                    <Text>Last updated: April 10, 2021</Text>
                    <Text>Please read these terms and conditions carefully before using Our Service.</Text>
                    <Heading as="h3" mt={4}>Interpretation and Definitions</Heading>
                    <Heading as="h3" mt={4}>Interpretation</Heading>
                    ...
                    <Heading as="h3" mt={4}>Definitions</Heading>
                    ...
                    <UnorderedList>
                        ...
                        <ListItem>
                            <Text><strong>Country</strong> refers to: Connecticut,  United States</Text>
                        </ListItem>
                        <ListItem>
                            <Text><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Coffeeclass.</Text>
                        </ListItem>
                        <ListItem>
                        ...
                        <ListItem>
                            <Text><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a href="https://www.privacypolicies.com/terms-conditions-generator/" target="_blank">Terms and Conditions Generator</a>.</Text>
                        </ListItem>
                        <ListItem>
                        ...
                        <ListItem>
                            <Text><strong>Website</strong> refers to Coffeeclass, accessible from <a href="https://coffeeclass.io" rel="external nofollow noopener" target="_blank">https://coffeeclass.io</a></Text>
                        </ListItem>
                        <ListItem>
                    ...
                    <Heading as="h2" mt={4}>Acknowledgment</Heading>
                    ...
                    <Heading as="h2" mt={4}>Links to Other Websites</Heading>
                    ...
                    <Heading as="h2" mt={4}>Termination</Heading>
                    ...
                    <Heading as="h2" mt={4}>Limitation of Liability</Heading>
                    ...
                    <Heading as="h2" mt={4}>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</Heading>
                    ...
                    <Heading as="h2" mt={4}>Governing Law</Heading>
                    ...
                    <Heading as="h2" mt={4}>Disputes Resolution</Heading>
                    ...
                    <Heading as="h2" mt={4}>For European Union (EU) Users</Heading>
                    ...
                    <Heading as="h2" mt={4}>United States Legal Compliance</Heading>
                    ...
                    <Heading as="h2" mt={4}>Severability and Waiver</Heading>
                    <Heading as="h3" mt={4}>Severability</Heading>
                    ...
                    <Heading as="h3" mt={4}>Waiver</Heading>
                    ...
                    <Heading as="h2" mt={4}>Translation Interpretation</Heading>
...
You agree that the original English text shall prevail in the case of a dispute.</Text>
                    <Heading as="h2" mt={4}>Changes to These Terms and Conditions</Heading>
                    ...
                    <Heading as="h2" mt={4}>Contact Us</Heading>
                    <Text>If you have any questions about these Terms and Conditions, You can contact us:</Text>
                    <UnorderedList>
                        <ListItem>By email: business.benjamincarlson@gmail.com</ListItem>
                    </UnorderedList>
                </Flex>
            </Stack>
        </Container>
