...
Breakpoints allow us to easily make any components responsive. They simply render to [media queries](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_Queries/Using_media_queries).
