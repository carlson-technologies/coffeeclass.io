...
authorPosition: 'Founder Coffeeclass LLC'
...
headings:
  [
    ...
    { "h2": "Setup" },
    { "h2": "Imports" },
    { "h2": "Adding Desktop Content" },
    { "h2": "Adding Mobile Content" },
    { "h2": "Using useState To Open And Close Navigation" },
    { "h2": "Completed Code" }
  ]
---
...
clone their starter example using Chakra-UI. If you dont want
to leave this page the command is simply `yarn create next-app --example with-chakra-ui with-chakra-ui-app`.
...
First, wap everything inside of a `Flex` element. Then, add the below code.
